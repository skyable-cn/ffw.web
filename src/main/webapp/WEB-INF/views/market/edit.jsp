        ...
        <form enctype="multipart/form-data" class="layui-form" method="post" action="<%=request.getContextPath()%>/market/edit">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		<tr><td><input id="file-0" type="file" lt="image-0" name="file-0" onchange="showImg(this)" accept="image/*" lay-verify="nikename"/></td><td><img src="<%=request.getContextPath()%>/file/image?FILENAME=${pd.FILEPATH1}" alt="商城Logo图片"  width="150px" id="image-0" style="cursor:pointer;"/></td><td></td></tr>
                  	</table>
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.MARKETNAME}">
              </div>
          </div>
           <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc3" name="MARKETDESC" class="layui-textarea">${pd.MARKETDESC}</textarea>
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
          ...
          <div class="layui-form-item wx-div" style="display:none;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.WXAPPID}">
              </div>
          </div>
          <div class="layui-form-item wx-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.WXAPPSECRET}">
              </div>
          </div>
          <div class="layui-form-item wx-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.WXMCHID}">
              </div>
          </div>
          <div class="layui-form-item wx-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.WXMCHKEY}">
              </div>
          </div>
          <div class="layui-form-item wx-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
          ...
          <div class="layui-form-item">
              <label class="layui-form-label"><span class="x-red">*</span>关联小程序</label>
              <div class="layui-input-inline" style="height:50px;">
                <input value="1" type="checkbox" name="DYFLAG" lay-skin="primary" title="抖音" lay-filter="filter" <c:if test="${pd.DYFLAG eq 1}">checked="checked"</c:if>><div class="layui-unselect layui-form-checkbox layui-form-checked" lay-skin="primary"><span>抖音</span><i class="layui-icon layui-icon-ok"></i></div>
              </div>
          </div>
          <div class="layui-form-item dy-div" style="display:none;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.DYAPPID}">
              </div>
          </div>
          <div class="layui-form-item dy-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.DYAPPSECRET}">
              </div>
          </div>
          <div class="layui-form-item dy-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.DYMCHID}">
              </div>
          </div>
          <div class="layui-form-item dy-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.DYMAPPID}">
              </div>
          </div>
          <div class="layui-form-item dy-div" style="display:none;">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.DYMAPPSECRET}">
              </div>
          </div>
          <div class="layui-form-item dy-div">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.ALIAPPID}">
              </div>
          </div>
          <div class="layui-form-item dy-div">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc33" name="ALIPRIVATEKEY" class="layui-textarea">${pd.ALIPRIVATEKEY}</textarea>
              </div>
          </div>
          <div class="layui-form-item dy-div">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc333" name="ALIPUBLICKEY" class="layui-textarea">${pd.ALIPUBLICKEY}</textarea>
              </div>
          </div>
          <div class="layui-form-item">
