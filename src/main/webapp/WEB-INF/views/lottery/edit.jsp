        ...
        <form enctype="multipart/form-data" class="layui-form" method="post" action="<%=request.getContextPath()%>/lottery/edit">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		<tr><td><input id="file" type="file" name="file" onchange="showImg(this)" accept="image/*" lay-verify="nikename1"/></td><td><img src="<%=request.getContextPath()%>/file/image?FILENAME=${pd.FILEPATH}"  alt="抽奖图片"  width="150px" id="image" style="cursor:pointer;"/></td><td></td></tr>
                  	</table>
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc2" name="LOTTERYRULE" class="layui-textarea">${pd.LOTTERYRULE}</textarea>
              </div>
          </div>
		<div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.SPONSORNAME}">
              </div>
          </div>
           <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.SPONSORURL}">
              </div>
          </div>
          <div class="layui-form-item">
