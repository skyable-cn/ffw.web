         ...
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		...
                  		<tr><td><input value="${item.START}"/></td><td><input value="${item.END}"/></td><td><input value="${item.MONEY}"/></td><td><button class="layui-btn layui-btn-primary delete" type="button">删除</button></td></tr>
                  		</c:forEach>
                  		</tbody>
                  	</table>
              </div>
