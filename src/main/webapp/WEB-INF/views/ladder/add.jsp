...
<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
        <form id="form" class="layui-form" method="post" action="<%=request.getContextPath()%>/ladder/save">
              ...
              <div class="layui-input-inline">
                  <select id="rolemodule" name="GOODS_ID" class="valid">
                    <c:forEach var="goods" items="${goodsData}">
                    	<option value="${goods.GOODS_ID}">${goods.GOODSNAME} (${goods.SHOPNAME})</option>
                    </c:forEach>
                  </select>
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		<tr><td colspan="4" style="border: none;"><button class="layui-btn layui-btn-primary add"  type="button" style="float: right;">添加一行</button></td></tr>
                  		<tr class="thd"><td>开始值</td><td>结束值</td><td>价格</td><td>操作</td></tr>
                  		<tbody id="tbd">
                  		<tr><td><input/></td><td><input/></td><td><input/></td><td><button class="layui-btn layui-btn-primary delete" type="button">删除</button></td></tr>
                  		</tbody>
                  	</table>
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <button  class="layui-btn sure" type="button">
                  增加
              </button>
          </div>
      </form>
