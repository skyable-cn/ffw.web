        ...
        <form class="layui-form" method="post" action="<%=request.getContextPath()%>/coupon/edit">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.MONEY}">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <input class="layui-input" placeholder="开始日" name="STARTTIME" id="start" lay-key="1" autocomplete="off" value="${pd.STARTTIME}" lay-verify="nikename1">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <input class="layui-input" placeholder="结束日" name="ENDTIME" id="end" lay-key="2" autocomplete="off" value="${pd.ENDTIME}" lay-verify="nikename2">
              </div>
          </div>
          <div class="layui-form-item">
