...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="<%=request.getContextPath()%>/">${SYSTEM_NAME}</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','<%=request.getContextPath()%>/user/goInfo?USER_ID=${USER_SESSION.USER_ID}',800,500)">个人信息</a></dd>
              <dd><a onclick="logout()" href="javascript:;">退出</a></dd>
            </dl>
          </li>
