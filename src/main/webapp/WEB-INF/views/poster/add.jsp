...
<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
        <form enctype="multipart/form-data" class="layui-form" method="post" action="<%=request.getContextPath()%>/poster/save">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc2" name="POSTERDESC" class="layui-textarea"></textarea>
              </div>
          </div>
          <div class="layui-form-item">
