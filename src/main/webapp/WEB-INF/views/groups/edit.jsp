        ...
        <form enctype="multipart/form-data" class="layui-form" method="post" action="<%=request.getContextPath()%>/groups/edit">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		<tr><td><input id="file-0" type="file" lt="image-0" name="file-0" onchange="showImg(this)" accept="image/*" lay-verify="nikename110"/></td><td><img src="<%=request.getContextPath()%>/file/image?FILENAME=${pd.FILEPATH1}"  alt="展位图片"  width="150px" id="image-0" style="cursor:pointer;"/></td><td></td></tr>
                  	</table>
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc2" name="GROUPSDESC" class="layui-textarea">${pd.GROUPSDESC}</textarea>
              </div>
          </div>
		<div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		<tr><td><input id="file-1" type="file" lt="image-1" name="file-1" onchange="showImg(this)" accept="image/*" lay-verify="nikename111"/></td><td><img src="<%=request.getContextPath()%>/file/image?FILENAME=${pd.FILEPATH2}"  alt="展位图片"  width="150px" id="image-1" style="cursor:pointer;"/></td><td></td></tr>
                  	</table>
              </div>
          </div>
          <div class="layui-form-item">
