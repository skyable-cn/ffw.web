...
<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
        <form class="layui-form" method="post" action="<%=request.getContextPath()%>/notice/save">
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
                  <span class="x-red">*</span>消息内容
              </label>
              <div class="layui-input-inline">
                  <textarea placeholder="请输入内容" id="desc4" name="NOTICECONTENT" class="layui-textarea"></textarea>
              </div>
          </div>
          <div class="layui-form-item">
