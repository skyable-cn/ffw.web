...
public class MemberController extends BaseController {
	...
	public ModelAndView listPage() throws Exception {
		...
		Page page = rest.post(IConstant.FFW_SERVICE_KEY, "member/listPage", pd, Page.class);

		List<PageData> typeData = rest.postForList(IConstant.FFW_SERVICE_KEY, "member/listAllType", pd,
